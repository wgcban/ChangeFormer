...
def get_args():
    ...
    parser.add_argument('--project_name', default='CD_base_transformer_pos_s4_dd8_DSIFN_b8_lr0.01_train_test_200_linear', type=str)
    parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
    parser.add_argument('--checkpoint_root', default='/media/lidan/ssd2/ChangeFormer/checkpoints/', type=str)
    parser.add_argument('--output_folder', default='samples_DSIFN/predict_BIT', type=str)
