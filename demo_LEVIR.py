...
def get_args():
    ...
    parser.add_argument('--project_name', default='CD_Unet_LEVIR_b8_lr0.01_sgd_train_test_200_linear_ce', type=str)
    parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
    parser.add_argument('--checkpoint_root', default='/media/lidan/ssd2/ChangeFormer/checkpoints/', type=str)
    parser.add_argument('--output_folder', default='samples_LEVIR/predict_CD_Unet', type=str)
    ...
    parser.add_argument('--net_G', default='Unet', type=str,
                        help='ChangeFormerV6 | CD_SiamUnet_diff | SiamUnet_conc | Unet | base_resnet18 | base_transformer_pos_s4_dd8 | base_transformer_pos_s4_dd8_dedim8|')
