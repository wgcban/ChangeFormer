...
def get_args():
    ...
    parser.add_argument('--project_name', default='CD_DTCDSCN_LEVIR_b8_lr0.01_sgd_train_test_200_linear_ce', type=str)
    parser.add_argument('--gpu_ids', type=str, default='0', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
    parser.add_argument('--checkpoint_root', default='/media/lidan/ssd2/ChangeFormer/checkpoints/', type=str)
    parser.add_argument('--output_folder', default='samples_LEVIR/predict_CD_DTCDSCN', type=str)
    ...
    parser.add_argument('--net_G', default='DTCDSCN', type=str,
